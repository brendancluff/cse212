...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: // Defect(s) Found: People with remaining turns were not being re-added to the queue correctly. 
// The queue returned Sue when Bob or Tim was expected, causing the turn order to fail.
